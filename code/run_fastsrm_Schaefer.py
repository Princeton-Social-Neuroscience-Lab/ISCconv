...
def main():
    ...
    parser.add_argument('--atlas_path', type=str, 
                        default='./data/atlases/Schaefer2018_100Parcels_17Networks_order_FSLMNI152_2mm.nii.gz.npy',
                        help="Path to the parcellation atlas (NIfTI).")
    parser.add_argument('--atlas_label', type=str, 
                        default='shaefer100p17n',
    ...
    for cond in args.conditions:
        ...
        if args.do_isc:
            ...
            atlas = fetch_atlas_schaefer_2018(n_rois=100, yeo_networks=17)  # Adjust n_rois if needed
            ...
            for i in range(n_trials):
                ...
                # Optionally, print some summary stats. LMT-- it would be nice to have this output as a result file but for now keeping here. 
