...
def main():
    ...
    parser.add_argument('--atlas_path', type=str, 
                        default='./data/atlases/glasser360MNI.nii.npy',
    ...
    for cond in args.conditions:
        ...
        if args.do_isc:
            ...
            # atlas = fetch_atlas_harvard_oxford("cort-maxprob-thr25-2mm")  # Adjust n_rois if needed

            #atlas_img = Brain_Data(atlas['maps'])  # NIfTI atlas
            atlas_img = Brain_Data(./data/atlases/glasser360MNI.nii')
