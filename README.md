...
## `code`
The [code](code/) folder contains multiple files to which was used to run the analyses and generate the figures.

## `figures`
The [figures](figures/) folder contains the output figures included in the manuscript.
